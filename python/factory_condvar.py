#!/usr/bin/env python3
#
# factory_condvar.py -- a factory simulated with one real thread per worker.
#
# The baseline for factory_guarded.py: the same program, written the usual
# way, with threading.Condition.
#
